function About() {
    return (
      <div className="text-center">
        ...
        <br></br>
        Your mission is to navigate through the busy streets, dodging obstacles and points along the way to unlock power-ups and upgrades. 
        With each level, the challenges become increasingly difficult, so you'll need to stay on your toes to achieve the highest score possible.
        <br></br>
